...
export function plotONLine(targetElementId, title, instruction) {
    ...
    const yScale = d3.scaleLinear()
        .domain([0, plotSize]) // Adjusted domain
        .range([innerHeight, 0]);
    ...
    const oNLine = g.append("line")
        ...
        .on("mouseover", function() { // Add mouseover event handler
            ...
            g.append("text") // Append text element on mouseover
                ...
                .attr("y", yScale(plotSize) + 80) // Adjust position relative to the line
                .style("text-anchor", "end")
                .text("Perfect match to Big O's arm!");
        })
