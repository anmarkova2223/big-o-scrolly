...
export function plotNLogNLine(targetElementId, title, instruction) {
    ...
    const plotSize = 28; // Adjusted plot size
    ...
    const oNLogNLine = g.append("path")
        ...
        .on("mouseover", function() { // Add mouseover event handler
            ...
            g.append("text") // Append text element on mouseover
                ...
                .attr("x", xScale(plotSize) + 40) // Adjust position relative to the line
                .attr("y", yScale(plotSize) + 60) // Adjust position relative to the line
                .style("text-anchor", "end")
                .text("This is a mid complexity.");
        })
